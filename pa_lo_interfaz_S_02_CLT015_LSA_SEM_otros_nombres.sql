...
IF OBJECT_ID ('dbo.pa_lo_interfaz_S_02_CLT015_LSA_SEM_otros_nombres') IS NOT NULL
	DROP PROCEDURE dbo.pa_lo_interfaz_S_02_CLT015_LSA_SEM_otros_nombres
GO

CREATE PROCEDURE [dbo].[pa_lo_interfaz_S_02_CLT015_LSA_SEM_otros_nombres]
    @fecha_proceso  SMALLDATETIME ,
    @salida	        TINYINT OUT
AS
/*
Nombre             : pa_lo_interfaz_S_02_CLT015_LSA_SEM_otros_nombres
...
Autor              : Miguel Cornejo J
   ...
   EXEC pa_lo_interfaz_S_02_CLT015_LSA_SEM_otros_nombres '16/12/2014',0
...
SELECT  SUBSTRING(REPLICATE('0',9 -DATALENGTH(RTRIM(CONVERT(CHAR(9),a.rut))))+ RTRIM(CONVERT(CHAR(9),a.rut)),1,9)+ --a.rut
       ...
       CASE WHEN a.rut > 50000000 THEN '2'       
       ELSE '4'
       END+  --fecha --tipo
...
GRANT EXECUTE ON dbo.pa_lo_interfaz_S_02_CLT015_LSA_SEM_otros_nombres TO Usuarios
GO
