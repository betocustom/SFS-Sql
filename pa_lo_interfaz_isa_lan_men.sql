USE [leaseoper]
GO
/****** Object:  StoredProcedure [dbo].[pa_lo_interfaz_isa_lan_men]    Script Date: 06/03/2014 16:20:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

/****** Objeto:  procedimiento almacenado dbo.pa_lo_interfaz_isa_lan_men    fecha de la secuencia de comandos: 09-07-2007 9:25:28 ******/
ALTER PROCEDURE [dbo].[pa_lo_interfaz_isa_lan_men]
@periodo_proceso   INT,
@salida            INT OUTPUT
AS
/*
Nombre            :  pa_lo_interfaz_isa_lan_men

Descripción       : Interfaz contratos en cuentas de orden

Parametros entrada: @periodo_proceso:
...
EXEC leaseoper..pa_lo_interfaz_isa_lan_men '19/03/2014',0
EXEC leaseoper..pa_lo_interfaz_isa_lan_men '24/03/2014',0
EXEC leaseoper..pa_lo_interfaz_isa_lan_men 201403,0
...
--
--
IF @periodo_proceso IS NULL OR @periodo_proceso = '190001'
BEGIN
   SELECT @salida = 0
...
--AND  CONVERT(INT, CONVERT(CHAR(6), fecha_ing_carta_recep, 112)) < = @periodo_proceso
...
GRANT EXEC ON pa_lo_interfaz_isa_lan_men TO Usuarios
