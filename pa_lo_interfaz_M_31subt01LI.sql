...
IF OBJECT_ID ('dbo.pa_lo_interfaz_M_31subt01LI') IS NOT NULL
	DROP PROCEDURE dbo.pa_lo_interfaz_M_31subt01LI
GO

CREATE PROCEDURE [dbo].[pa_lo_interfaz_M_31subt01LI]
    @fecha_proceso  SMALLDATETIME ,
    @salida	        TINYINT OUT
AS
/*
Nombre             : pa_lo_interfaz_M_31subt01LI
...
Autor              : Miguel Cornejo J
   ...
   EXEC pa_lo_interfaz_M_31subt01LI '16/12/2014',0
      ...
      convert(CHAR(9), c.cod_material) +--mater_agri
       ...
       (SELECT convert(CHAR(15), loc.descripcion)
         ...
         WHERE cdir.rut = a.rut
           AND cdir.cod_comuna = loc.cod_comuna_cia  )+ --comun_agri	
       	(
...
GRANT EXECUTE ON dbo.pa_lo_interfaz_M_31subt01LI TO Usuarios
GO
