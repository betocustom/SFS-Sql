...
IF OBJECT_ID ('dbo.pa_lo_interfaz_D24_OUT') IS NOT NULL
	DROP PROCEDURE dbo.pa_lo_interfaz_D24_OUT
GO

CREATE PROCEDURE [dbo].[pa_lo_interfaz_D24_OUT]
    @fecha_proceso  SMALLDATETIME ,
    @salida	    TINYINT OUT
AS
/*
Nombre             : pa_lo_interfaz_D24_OUT
...
Autor              : Carlos Beltran Galaz
   ...
   EXEC pa_lo_interfaz_D24_OUT '16/12/2014',0
...
GRANT EXECUTE ON dbo.pa_lo_interfaz_D24_OUT TO Usuarios
GO
