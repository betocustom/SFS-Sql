...
IF OBJECT_ID('dbo.pa_lo_interfaz_M_31casc01LI') IS NOT NULL
	DROP PROCEDURE dbo.pa_lo_interfaz_M_31casc01LI
GO

CREATE PROCEDURE [dbo].[pa_lo_interfaz_M_31casc01LI] @fecha_proceso SMALLDATETIME
	,@salida TINYINT OUT
AS
/*
Nombre             : pa_lo_interfaz_M_31casc01LI
...
Autor              : Miguel Cornejo J
   ...
   EXEC pa_lo_interfaz_M_31casc01LI '16/12/2014',0
...
SELECT convert(CHAR(8), @fecha_proceso, 112) + --fecha_proc 
	...
	a.cli_dv + --dveri_casc
	convert(CHAR(4), (d.cod_rubro * 100) + d.cod_rubro_especifico) + --crubr_casc       
	convert(CHAR(40), a.direccion) + --domic_casc
	(
...
GRANT EXECUTE
	ON dbo.pa_lo_interfaz_M_31casc01LI
	TO Usuarios
GO
