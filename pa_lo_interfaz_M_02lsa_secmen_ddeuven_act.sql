...
IF OBJECT_ID ('dbo.pa_lo_interfaz_M_02lsa_secmen_ddeuven_act') IS NOT NULL
	DROP PROCEDURE dbo.pa_lo_interfaz_M_02lsa_secmen_ddeuven_act
GO

CREATE PROCEDURE [dbo].[pa_lo_interfaz_M_02lsa_secmen_ddeuven_act]
    @fecha_proceso  SMALLDATETIME ,
    @salida	        TINYINT OUT
AS
/*
Nombre             : pa_lo_interfaz_M_02lsa_secmen_ddeuven_act
...
Autor              : Miguel Cornejo J
   ...
   EXEC pa_lo_interfaz_M_02lsa_secmen_ddeuven_act '16/12/2014',0
...
SELECT 'C'+
     ...
     --[Detalle]-- 
       ...
       str(cuo.valor_cuota_total,13,2)+
       str(cuo.interes,13,2)+       
--Trailer---
       'T'+--filler
...
GRANT EXECUTE ON dbo.pa_lo_interfaz_M_02lsa_secmen_ddeuven_act TO Usuarios
GO
