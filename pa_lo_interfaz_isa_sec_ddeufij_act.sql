USE [leaseoper]
GO
/****** Object:  StoredProcedure [dbo].[pa_lo_interfaz_isa_sec_ddeufij_act]    Script Date: 06/03/2014 16:20:09 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

/****** Objeto:  procedimiento almacenado dbo.pa_lo_interfaz_isa_sec_ddeufij_act    fecha de la secuencia de comandos: 09-07-2007 9:25:28 ******/
ALTER PROCEDURE [dbo].[pa_lo_interfaz_isa_sec_ddeufij_act]
@fecha_proceso    SMALLDATETIME,
@salida            INT OUTPUT
AS
/*
Nombre            :  pa_lo_interfaz_isa_sec_ddeufij_act
...
EXEC leaseoper..pa_lo_interfaz_isa_sec_ddeufij_act '19/03/2014',0
EXEC leaseoper..pa_lo_interfaz_isa_sec_ddeufij_act '24/03/2014',0
...
--WHERE  --a.estado_operacion = 2 --contrato vigente
  ...
  --AND  a.fecha_ing_carta_recep)      < = @fecha_proceso
OPEN c_cto
...
GRANT EXEC ON pa_lo_interfaz_isa_sec_ddeufij_act TO Usuarios
